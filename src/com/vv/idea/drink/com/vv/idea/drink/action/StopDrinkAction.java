 ...
 */
public class StopDrinkAction extends AnAction {

    @Override
    public void actionPerformed(AnActionEvent e) {
        int i = Messages.showYesNoDialog("Stop drink?", "Drink Setting", null);
        if (Enums.YES_NO_DIALOG.YES.type.equals(i)) {
            PropertiesHandler.getAppProp().setValue(DRINK_JOB_STATUS, Enums.JOB_STATUS.PAUSE.type);
            new JobHandler(MyCache.scheduler).pauseJob(DRINK_JOB_NAME, DRINK_JOB_GROUP);
        }
    }
}
